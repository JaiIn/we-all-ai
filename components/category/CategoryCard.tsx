...
export default function CategoryCard({ category, index }: CategoryCardProps) {
  ...
  return (
    <div 
      className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/50 overflow-hidden h-[420px] flex flex-col transition-shadow duration-300"
      style={{ 
