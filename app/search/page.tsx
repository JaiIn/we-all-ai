...
export default function SearchPage() {
  ...
  useEffect(() => {
    ...
    if (urlCategory || urlPricing) {
      updateFilters({
        category: urlCategory || undefined,
        pricing: (urlPricing as 'free' | 'paid' | 'all') || 'all'
      });
    }
  }, [searchParams, setQuery, updateFilters]);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-40 pb-20">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 min-w-0">
            {showResults ? (
              hasResults ? (
                <SearchResults tools={searchResults.tools} query={query} />
              ) : (
                <SearchEmpty 
                  query={query} 
